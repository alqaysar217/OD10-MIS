...
const Appreciation: React.FC = () => {
  ...
  },
  {
  ...
  },
   {
    ...
    from: "أ. أسماء بانوبي",
    to: "دفعة مطور المنظمة",
    message: "سعدت جداً بتدريس دفعة 'مطور المنظمة' الموهوبة. لقد رأيت فيكم شغفاً حقيقياً بالتعلم ورغبة في التطور. أتمنى لكم كل التوفيق في مسيرتكم المهنية، ومؤمنة بأنكم ستحققون إنجازات عظيمة.",
    type: "teacher-to-students",
    date: "2024-03-14"
  },
  {
    ...
    from: "أ. سوزان",
    to: "دفعة مطور المنظمة",
    message: "إلى دفعة 'مطور المنظمة' المتميزة، لقد كنتم نموذجاً للجد والمثابرة والإبداع. تابعتُ باعتزاز نموكم الأكاديمي والشخصي، ورأيتُ فيكم الشغف الحقيقي بالمعرفة والابتكار. مسيرتكم الجامعية قد انتهت، لكن رحلة العطاء والإنجاز بدأت للتو. ثقتي بكم كبيرة في أنكم ستكونون رواداً في مجالاتكم. كل التوفيق في حياتكم المهنية والشخصية، فخورة جداً بكم.",
    type: "teacher-to-students",
    date: "2024-03-10"
  },
  {
